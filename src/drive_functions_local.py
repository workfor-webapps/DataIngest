...
def download_model_into_memory():
    from google.cloud import storage
    
    """Downloads a model into memory."""
    # The ID of your GCS bucket
    # bucket_name = "your-bucket-name"
    logger.info("getting bucket for cloud store")
    bucket_name = "dataingest-26020.appspot.com"

    # The ID of your GCS object
    blob_name = "model.pickle"
    ...
    logger.info("downloading model from cloud bucket")
    blob = bucket.blob(blob_name)
    final_byte = blob.download_as_string()
...
def load_pickle():
    import pickle
    with open('./static/model_pickle', 'rb') as f:
